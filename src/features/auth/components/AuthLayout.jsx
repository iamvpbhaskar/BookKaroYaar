...
export function BrandMark() { return <Typography component="div" sx={{ fontWeight: 900, letterSpacing: '-.07em', fontSize: 23 }}>BookKaro<span style={{ color: '#FEC29F' }}>Yaar</span></Typography> }
export function AuthLayout({ eyebrow, title, description, children }) {
  return <Box sx={{ minHeight: '100vh', display: 'grid', gridTemplateColumns: { md: 'minmax(360px,.94fr) minmax(440px,1.06fr)' }, background: '#1D2630' }}>
